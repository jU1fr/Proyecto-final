...
namespace RM.View
{
    public partial class frmKitchenView : Form
    {
        ...
        private void GetOrders()
        {
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                string qry2 = @"Select p.pName, d.qty from tblDetails d
                ...
                if (dt2.Rows.Count == 0)
                {
                    MessageBox.Show("No product details found for MainID: " + mid);
                    continue;
                }
    ...
    internal class Hashtable : System.Collections.Hashtable
    {
    }
}
